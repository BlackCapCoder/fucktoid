...
/* package fuck-0.1.0.0 */
#define VERSION_fuck "0.1.0.0"
#define MIN_VERSION_fuck(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "fuck-0.1.0.0-EwiY2Yl7ELs8DLBVT8uRh2"

#define CURRENT_PACKAGE_KEY "fuck-0.1.0.0-EwiY2Yl7ELs8DLBVT8uRh2"
