...
/* package omega-0.1.0.0 */
#define VERSION_omega "0.1.0.0"
#define MIN_VERSION_omega(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
/* package control-monad-omega-0.3.1 */
#define VERSION_control_monad_omega "0.3.1"
...
#define CURRENT_COMPONENT_ID "omega-0.1.0.0-JhVSwyU3hLx5kO8rF4QRkY"

#define CURRENT_PACKAGE_KEY "omega-0.1.0.0-JhVSwyU3hLx5kO8rF4QRkY"
