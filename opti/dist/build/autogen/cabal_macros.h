...
/* package opti-0.1.0.0 */
#define VERSION_opti "0.1.0.0"
#define MIN_VERSION_opti(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "opti-0.1.0.0-3uP7ptovC5kEg4v05GtYW7"

#define CURRENT_PACKAGE_KEY "opti-0.1.0.0-3uP7ptovC5kEg4v05GtYW7"
